  ...
  return (
    <div className="group relative flex gap-4">
      ...
      <div className="flex flex-col items-center">
        <div className={`flex h-10 w-10 shrink-0 items-center justify-center rounded-full border-2 ${colorClass} transition-transform group-hover:scale-110`}>
      ...
      <div className="pb-8 flex-1">
        <div className="flex items-center gap-3 mb-1">
          ...
          <Badge variant="secondary" className={`text-[10px] px-2 py-0 ${colorClass} border`}>
            {activity.type}
          </Badge>
        </div>
    ...
    <div className="rounded-2xl border border-border bg-card overflow-hidden transition-shadow hover:shadow-lg">
      ...
      >
        <div className="flex items-center gap-4">
          <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-primary text-primary-foreground font-serif text-lg font-bold">
            D{dayPlan.day}
          </div>
          <div>
    ...
    >
      ...
      <div className="relative h-32 overflow-hidden">
        ...
        <div className="absolute bottom-3 left-4 right-4 flex items-end justify-between">
          <div>
            <h3 className="font-serif text-xl font-bold text-white drop-shadow-md">{dest.name}</h3>
            <p className="text-xs text-white/80">{dest.region} India</p>
          </div>
...
export function TripPlanner() {
  ...
  return (
    <section id="planner" className="py-24 px-6 bg-background">
      <div className="mx-auto max-w-7xl">
        {/* Header */}
        <div className="text-center mb-16">
          <Badge variant="secondary" className="mb-4 bg-primary/10 text-primary border-0">Trip Planner</Badge>
        ...
        <Card className="border-border bg-card mb-10 overflow-hidden">
          ...
          <CardContent className="p-6 md:p-8">
            <div className="grid gap-6 md:grid-cols-4 items-end">
              ...
              <Button size="lg" onClick={() => { setShowResults(true); setSelectedDest("") }} className="w-full" disabled={!origin}>
        ...
        {results.length === 0 && showResults && (
          <div className="text-center py-12 mb-10">
            <p className="text-muted-foreground">No destinations match your filters. Try adjusting your preferences.</p>
          </div>
        )}
        ...
        {selectedDest && itinerary && (
          <div>
                ...
                <div className="grid gap-6 md:grid-cols-2 mb-6">
                  <div>
                    <Label className="text-card-foreground flex items-center justify-between mb-3">
                      <span className="flex items-center gap-2"><Calendar className="h-4 w-4 text-primary" /> Trip Duration</span>
                      <span className="font-bold text-primary">{tripDays} days</span>
                    </Label>
                    <Slider
                      value={[tripDays]}
                  ...
                  <div>
                    <Label className="text-card-foreground flex items-center justify-between mb-3">
                      ...
                      <span className="font-bold text-primary">{tripTravelers}</span>
                    </Label>
                    <Slider
                      value={[tripTravelers]}
            ...
            {tripDays > itinerary.days.length && (
              <div className="mt-4 flex items-start gap-3 rounded-xl border border-border bg-secondary/50 p-4">
