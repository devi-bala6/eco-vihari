...
export function GreenAlternatives() {
  return (
    <section id="alternatives" className="py-24 px-6 bg-secondary">
      <div className="mx-auto max-w-7xl">
        <div className="text-center mb-16">
          <Badge variant="secondary" className="mb-4 bg-primary/10 text-primary border-0">Greener Choices</Badge>
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {alternatives.map((alt) => {
            const Icon = alt.icon
            return (
              <Card key={alt.title} className="overflow-hidden border-border bg-card group">
                ...
                <CardContent className="p-6">
                  ...
                  <a href="#planner" className="mt-4 inline-flex items-center gap-1 text-sm font-medium text-primary hover:underline">
        ...
        <div className="mt-12 grid grid-cols-2 gap-4 md:grid-cols-4">
          {quickTips.map((tip) => {
            const Icon = tip.icon
            return (
              <div key={tip.tip} className="flex items-center gap-3 rounded-xl bg-card border border-border p-4">
